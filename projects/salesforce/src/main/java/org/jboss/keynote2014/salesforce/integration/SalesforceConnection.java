...
public class SalesforceConnection
{
    ...
    private static final String CLIENT_ID = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
    private static final String CLIENT_SECRET = "xxxxxxxxxxxxxxxxxxxxx";

    private static final String USERNAME = "xxxxxxxxxxxxxxxxxxx";
    private static final String PASSWORD = "xxxxxxxxxxxxxxxxxxxxx";
